...
namespace Web_Hutech_Gear.Areas.Admin.Controllers
{
    public class RestoreController : Controller
    {
        ...
        public ActionResult Partial_Status()
        {
            var items = db.Status.Where(p => p.IsActivate);
            return PartialView(items);
        }
        [HttpPost]
        ...
        [HttpPost]
        public ActionResult status_deleteAll(string ids)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
        ...
        [HttpPost]
        public ActionResult status_restore(int id)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
                try
        ...
        [HttpPost]
        public ActionResult status_restoreAll(string ids)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
